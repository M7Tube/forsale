<div>
    ...
    <form wire:submit.prevent="add">
        ...
        <div class="container">
            <div class="card p-3">
                ...
                <input type="text" wire:model="ar_title" id="ar_title"
                    placeholder="{{ __('Enter Arabic Title') }}" class="form-control">
            </div>
        </div>
        <br>
        <div class="container">
                            ...
                            @if ($picture)
                                @forelse ($picture as $pic)
                                    <div class="col-6 col-md-3">
                                        <img src="{{ $pic->temporaryUrl() }}" alt="preview pictures"
                                            width="175px">
                                    </div>
                                @empty
                                @endforelse
        ...
        <div class="container">
            <div class="card p-3">
                <h6>{{ $category == 1 || $category == 2 ? __('Price') : __('Salary') }}
                </h6>
                <div class="col-12">
                    <input class="form-control" type="number"
                        wire:model="{{ $category == 1 || $category == 2 ? 'price' : 'salary' }}"
                        id="{{ $category == 1 || $category == 2 ? 'price' : 'salary' }}">
                </div>
            </div>
        </div>
        <br>
