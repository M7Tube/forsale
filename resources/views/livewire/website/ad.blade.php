                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->manufacturing_year ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->kilometrag ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->AdStatus->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->AdType->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->governorate->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->CarStatus->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RentOrSale->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Color->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RentalTime->ar_rent_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="p-4">
                                ...
                                @elseif (request('category') == 2)
                                    <h6>
                                        <span
                                            class="badge rounded-pill bg-secondary">{{ __('Real Estate') }}</span>
                                        <span
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RealEstateMainCategory->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->ApartmentStatus->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->land_size ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->building_size ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->room_count ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->apartment_size ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->CommercialAndArtificialType->ar_name ?? '' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->BuildingStatus->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->LandType->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Area->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Neighborhood->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        {{ __('Job Category') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->JobCategory->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->PersonLanguage->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->YearsOfExperience->ar_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->qualification ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->work_hour ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->extra_work_hour ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->work_hour_rent ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Ad Status') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->AdStatus->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Ad Type') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->AdType->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Governorate') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->governorate->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Car Status') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->CarStatus->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Rent Or Sale') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RentOrSale->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Color') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Color->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Rental Time') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RentalTime->en_rent_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        {{ __('Real Estate Main Category') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->RealEstateMainCategory->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->ApartmentStatus->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        {{ __('Commercial And Artificial Type') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->CommercialAndArtificialType->en_name ?? '' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->BuildingStatus->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Land Type') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->LandType->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Area') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Area->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">{{ __('Neighborhood') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->Neighborhood->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        {{ __('Real Estate Main Category') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->JobCategory->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        {{ __('Real Estate Main Category') }}</div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->PersonLanguage->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6">{{ $ad->YearsOfExperience->en_name ?? '' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
