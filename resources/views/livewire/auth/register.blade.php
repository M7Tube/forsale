                                ...
                                <form wire:submit.prevent="create">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputemail">{{ __('Email') }} <i class="bi bi-envelope-fill"></i> <span
                                                        class="text-danger">*</span></label>
                                                {{-- <span class="text-danger">
                                                    @error('email')
                                                        {{ $message }}
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputpassword">{{ __('Password') }}<span class="text-danger">*</span>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputpassword_confirmation">{{ __('Confirm Password') }}<span
                                    ...
                                    @if (!$errors->any())
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit"
                                                class="mx-auto w-100 btn btn-block btn-outline-success">{{ __('Create') }} <i
                                                    class="bi bi-plus-square"></i></button>
                                        </div>
                                    @else
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit"
                                                class="mx-auto w-100 btn btn-block btn-outline-success" disabled>{{ __('Create') }}
