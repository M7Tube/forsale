...
} elseif ($_instance->childHasBeenRendered('LSDtq3t')) {
    $componentId = $_instance->getRenderedChildComponentId('LSDtq3t');
    $componentTag = $_instance->getRenderedChildComponentTagName('LSDtq3t');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LSDtq3t');
} else {
    $response = \Livewire\Livewire::mount('website.my-ads');
    $html = $response->html();
    $_instance->logRenderedChild('LSDtq3t', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
