...
} elseif ($_instance->childHasBeenRendered('6RHTC99')) {
    $componentId = $_instance->getRenderedChildComponentId('6RHTC99');
    $componentTag = $_instance->getRenderedChildComponentTagName('6RHTC99');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6RHTC99');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('6RHTC99', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
