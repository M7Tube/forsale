...
} elseif ($_instance->childHasBeenRendered('XNo4SV9')) {
    $componentId = $_instance->getRenderedChildComponentId('XNo4SV9');
    $componentTag = $_instance->getRenderedChildComponentTagName('XNo4SV9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XNo4SV9');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('XNo4SV9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
