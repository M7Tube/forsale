...
} elseif ($_instance->childHasBeenRendered('YkAQZSW')) {
    $componentId = $_instance->getRenderedChildComponentId('YkAQZSW');
    $componentTag = $_instance->getRenderedChildComponentTagName('YkAQZSW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YkAQZSW');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('YkAQZSW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
