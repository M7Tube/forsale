...
} elseif ($_instance->childHasBeenRendered('ejXWJ2b')) {
    $componentId = $_instance->getRenderedChildComponentId('ejXWJ2b');
    $componentTag = $_instance->getRenderedChildComponentTagName('ejXWJ2b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ejXWJ2b');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('ejXWJ2b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
