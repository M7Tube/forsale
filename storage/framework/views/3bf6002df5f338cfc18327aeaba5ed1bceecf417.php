...
} elseif ($_instance->childHasBeenRendered('asT8BmC')) {
    $componentId = $_instance->getRenderedChildComponentId('asT8BmC');
    $componentTag = $_instance->getRenderedChildComponentTagName('asT8BmC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('asT8BmC');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('asT8BmC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
