...
} elseif ($_instance->childHasBeenRendered('tmxHsSo')) {
    $componentId = $_instance->getRenderedChildComponentId('tmxHsSo');
    $componentTag = $_instance->getRenderedChildComponentTagName('tmxHsSo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tmxHsSo');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('tmxHsSo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
