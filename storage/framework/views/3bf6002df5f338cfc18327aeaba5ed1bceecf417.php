...
} elseif ($_instance->childHasBeenRendered('wiNi1yQ')) {
    $componentId = $_instance->getRenderedChildComponentId('wiNi1yQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('wiNi1yQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wiNi1yQ');
} else {
    $response = \Livewire\Livewire::mount('website.view-ads');
    $html = $response->html();
    $_instance->logRenderedChild('wiNi1yQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
