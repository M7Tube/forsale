                                        ...
                                        <ul class="mt-3 list-disc list-inside text-sm text-red-600">
                                            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="text-danger"><span
                                                        class="text-muted"><?php echo e($error); ?></span></li>
                                ...
                                <form wire:submit.prevent="create">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputemail"><?php echo e(__('Email')); ?> <i class="bi bi-envelope-fill"></i> <span
                                                        class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputpassword"><?php echo e(__('Password')); ?><span class="text-danger">*</span>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating mb-1">
                                                ...
                                                <label for="inputpassword_confirmation"><?php echo e(__('Confirm Password')); ?><span
                                    ...
                                    <?php if(!$errors->any()): ?>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit"
                                                class="mx-auto w-100 btn btn-block btn-outline-success"><?php echo e(__('Create')); ?> <i
                                                    class="bi bi-plus-square"></i></button>
                                        </div>
                                    <?php else: ?>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit"
                                                class="mx-auto w-100 btn btn-block btn-outline-success" disabled><?php echo e(__('Create')); ?>
