                    ...
                    <div class="col-6 col-sm-4 col-md-3 mb-5">
                        <a href="<?php echo e(route('website.ad', [app()->getLocale(), 'category' => 1, 'id' => $car->car_id])); ?>"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <span><?php echo e(app()->getLocale() == 'ar' ? $car->ar_title ?? '' : $car->en_title ?? ''); ?></span>
                                </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 mb-5">
                        <a href="<?php echo e(route('website.ad', [app()->getLocale(), 'category' => 2, 'id' => $real_estate->real_estate_id])); ?>"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <span><?php echo e(app()->getLocale() == 'ar' ? $real_estate->ar_title ?? '' : $real_estate->en_title ?? ''); ?></span>
                                </div>
                                <div class="card-image-overlay p-1">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 mb-5">
                        <a href="<?php echo e(route('website.ad', [app()->getLocale(), 'category' => 3, 'id' => $job->job_id])); ?>"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <span><?php echo e(app()->getLocale() == 'ar' ? $job->ar_title ?? '' : $job->en_title ?? ''); ?></span>
                                </div>
                                <div class="card-image-overlay p-1">
