<div>
    <a href="<?php echo e(route('website.spcialAd', ['id' => $data['SpcialAd']['spcial_ad_id'], app()->getLocale()])); ?>">
        <div>
            <!-- ======= Hero Section ======= -->
            <?php if(file_exists(storage_path('app/img/' . $data['SpcialAd']['picture']))): ?>
                <div id="hero" class="hero route bg-image"
                    style="background-image: url('data:image/png|jpg|jpeg;base64, <?php echo base64_encode(file_get_contents(storage_path('app/img/' . $data['SpcialAd']['picture']))); ?>'); width: 100%;
                                height: 50vw;
                                object-fit: fill;">
                <?php else: ?>
                    <div id="hero" class="hero route bg-image"
    ...
    <div class="container my-5">
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <?php $__empty_1 = true; $__currentLoopData = $data['SpcialAdNG']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <a href="<?php echo e(route('website.spcialAd', ['id' => $ads->spcial_ad_id, app()->getLocale()])); ?>">
                            ...
                            <div class="carousel-caption d-md-block">
                                <?php if(app()->getLocale() == 'en'): ?>
                                    <h5 class="text-white"><?php echo e($ads->en_title ?? ''); ?></h5>
                                    <p class="text-white"><?php echo e($ads->en_desc ?? ''); ?></p>
                                <?php else: ?>
                                    <h5 class="text-white"><?php echo e($ads->ar_title ?? ''); ?></h5>
                                    <p class="text-white"><?php echo e($ads->ar_desc ?? ''); ?></p>
                                <?php endif; ?>
                            </div>
                        </a>
                    </div>
                                                            ...
                                                            <div class="media">
                                                                <div class="media-body text-center">
                                                                    <img src="<?php echo e(asset('img/home.svg')); ?>"
                                                                        alt="icon" width="150px"><br />
                                                                    <span
                                                                        class="mt-3"><?php echo e(__('Real Estate')); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php /**PATH C:\Users\Abo Samer\Desktop\Work\Waseetcom\_public_htewrml\_public_html\resources\views/livewire/website/home-page.blade.php ENDPATH**/ ?>