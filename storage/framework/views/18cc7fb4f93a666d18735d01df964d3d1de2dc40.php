                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->manufacturing_year ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->kilometrag ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->AdStatus->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->AdType->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->governorate->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->CarStatus->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RentOrSale->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Motion Vector')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->MotionVector->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Color->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RentalTime->ar_rent_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-4 p-3 text-center">
                        ...
                        <?php if($ad->isPhone_visable == 1): ?>
                            <button wire:click.prevent="" class="btn btn-block w-100 my-2"
                                ...
                                <i class="bi bi-telephone"></i> <?php echo e($ad->phone_number ?? ''); ?>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="p-4">
                                ...
                                <?php elseif(request('category') == 2): ?>
                                    <h6>
                                        <span
                                            class="badge rounded-pill bg-secondary"><?php echo e(__('Real Estate')); ?></span>
                                        <span
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RealEstateMainCategory->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->ApartmentStatus->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->land_size ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->building_size ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->floor ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->room_count ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->apartment_size ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->CommercialAndArtificialType->ar_name ?? ''); ?>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->BuildingStatus->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->LandType->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Area->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Neighborhood->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->JobCategory->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->PersonLanguage->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->YearsOfExperience->ar_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->qualification ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->age ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->work_hour ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->extra_work_hour ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->work_hour_rent ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Ad Status')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->AdStatus->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Ad Type')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->AdType->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Governorate')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->governorate->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Car Status')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->CarStatus->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Rent Or Sale')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RentOrSale->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Motion Vector')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->MotionVector->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Color')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Color->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Rental Time')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RentalTime->en_rent_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        <?php echo e(__('Real Estate Main Category')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->RealEstateMainCategory->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->ApartmentStatus->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        <?php echo e(__('Commercial And Artificial Type')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->CommercialAndArtificialType->en_name ?? ''); ?>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->BuildingStatus->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Land Type')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->LandType->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Area')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Area->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;"><?php echo e(__('Neighborhood')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->Neighborhood->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        <?php echo e(__('Real Estate Main Category')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->JobCategory->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    <div class="col-6" style="color: #33333384;">
                                        <?php echo e(__('Real Estate Main Category')); ?></div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->PersonLanguage->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                            ...
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-center">
                                        <div class="col-6"><?php echo e($ad->YearsOfExperience->en_name ?? ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-2 my-1" style="background-color:#F2F2F2;">
...
<?php /**PATH C:\Users\Abo Samer\Desktop\Work\Waseetcom\_public_htewrml\_public_html\resources\views/livewire/website/ad.blade.php ENDPATH**/ ?>