    ...
    <form wire:submit.prevent="add">
        ...
        <div class="container">
            <div class="card p-3">
                ...
                <input type="text" wire:model="ar_title" id="ar_title"
                    placeholder="<?php echo e(__('Enter Arabic Title')); ?>" class="form-control">
            </div>
        </div>
        <br>
        <div class="container">
                            ...
                            <?php if($picture): ?>
                                <?php $__empty_1 = true; $__currentLoopData = $picture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="col-6 col-md-3">
                                        <img src="<?php echo e($pic->temporaryUrl()); ?>" alt="preview pictures"
                                            width="175px">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <?php endif; ?>
        ...
        <div class="container">
            <div class="card p-3">
                <h6><?php echo e($category == 1 || $category == 2 ? __('Price') : __('Salary')); ?>

                </h6>
                <div class="col-12">
                    <input class="form-control" type="number"
                        wire:model="<?php echo e($category == 1 || $category == 2 ? 'price' : 'salary'); ?>"
                        id="<?php echo e($category == 1 || $category == 2 ? 'price' : 'salary'); ?>">
                </div>
            </div>
        </div>
        <br>
        ...
        <?php if($category == 1): ?>
            ...
            <div class="container">
                <div class="card p-3">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <h6><?php echo e(__('Continent Of Origin')); ?>
        ...
        <?php if($category == 2): ?>
            ...
            <div class="container">
                <div class="card p-3">
                    ...
                    <div class="col-12">
                        <input class="form-control" type="number" wire:model="apartment_size" id="apartment_size">
                    </div>
                </div>
            </div>
            <br>
        ...
        <?php if($category == 3): ?>
            ...
            <div class="container">
                <div class="card p-3">
                    ...
                    <div class="col-12">
                        <input class="form-control" type="number" wire:model="work_hour_rent" id="work_hour_rent">
                    </div>
                </div>
            </div>
            <br>
...
<?php /**PATH C:\Users\Abo Samer\Desktop\Work\Waseetcom\_public_htewrml\_public_html\resources\views/livewire/website/add-new-ad.blade.php ENDPATH**/ ?>