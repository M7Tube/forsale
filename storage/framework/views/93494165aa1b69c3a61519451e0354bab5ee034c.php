...
} elseif ($_instance->childHasBeenRendered('wVAXLYH')) {
    $componentId = $_instance->getRenderedChildComponentId('wVAXLYH');
    $componentTag = $_instance->getRenderedChildComponentTagName('wVAXLYH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wVAXLYH');
} else {
    $response = \Livewire\Livewire::mount('dashboard.users.index');
    $html = $response->html();
    $_instance->logRenderedChild('wVAXLYH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
