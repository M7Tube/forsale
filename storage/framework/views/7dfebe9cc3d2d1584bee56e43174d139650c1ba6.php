...
} elseif ($_instance->childHasBeenRendered('IMTrUqX')) {
    $componentId = $_instance->getRenderedChildComponentId('IMTrUqX');
    $componentTag = $_instance->getRenderedChildComponentTagName('IMTrUqX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IMTrUqX');
} else {
    $response = \Livewire\Livewire::mount('website.home-page');
    $html = $response->html();
    $_instance->logRenderedChild('IMTrUqX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
