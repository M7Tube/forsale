...
} elseif ($_instance->childHasBeenRendered('aP75kgZ')) {
    $componentId = $_instance->getRenderedChildComponentId('aP75kgZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('aP75kgZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aP75kgZ');
} else {
    $response = \Livewire\Livewire::mount('dashboard.all-ads.accept-ads');
    $html = $response->html();
    $_instance->logRenderedChild('aP75kgZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
