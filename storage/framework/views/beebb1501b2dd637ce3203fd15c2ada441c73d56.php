<?php $__env->startSection('tableName', __('Apartment Status')); ?>
...
<?php $__env->startSection('table-body'); ?>
    <?php $__empty_1 = true; $__currentLoopData = $AS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tbody>
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-primary mb-2" data-bs-toggle="modal"
                        data-bs-target="#editModal" wire:click.prevent="edit(<?php echo e($data->apartment_status_id); ?>)"><i
...
<?php $__env->startSection('create-model-body'); ?>
    <?php if(Session()->has('WrongApartmentStatus')): ?>
        <div class="alert alert-danger">
            <?php echo e(Session('WrongApartmentStatus')); ?>
...
<?php echo $__env->make('layouts.livewireLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Abo Samer\Desktop\Work\Waseetcom\_public_htewrml\_public_html\resources\views/livewire/dashboard/apartment-status/index.blade.php ENDPATH**/ ?>