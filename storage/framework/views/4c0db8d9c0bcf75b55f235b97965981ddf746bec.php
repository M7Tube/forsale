...
} elseif ($_instance->childHasBeenRendered('eMfU0hU')) {
    $componentId = $_instance->getRenderedChildComponentId('eMfU0hU');
    $componentTag = $_instance->getRenderedChildComponentTagName('eMfU0hU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eMfU0hU');
} else {
    $response = \Livewire\Livewire::mount('website.login');
    $html = $response->html();
    $_instance->logRenderedChild('eMfU0hU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
