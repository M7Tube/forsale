...
} elseif ($_instance->childHasBeenRendered('myImIHe')) {
    $componentId = $_instance->getRenderedChildComponentId('myImIHe');
    $componentTag = $_instance->getRenderedChildComponentTagName('myImIHe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('myImIHe');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('myImIHe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
