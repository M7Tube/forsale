...
} elseif ($_instance->childHasBeenRendered('aF3z7AL')) {
    $componentId = $_instance->getRenderedChildComponentId('aF3z7AL');
    $componentTag = $_instance->getRenderedChildComponentTagName('aF3z7AL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aF3z7AL');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('aF3z7AL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
