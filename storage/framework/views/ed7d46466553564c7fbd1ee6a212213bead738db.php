...
} elseif ($_instance->childHasBeenRendered('u1PitVh')) {
    $componentId = $_instance->getRenderedChildComponentId('u1PitVh');
    $componentTag = $_instance->getRenderedChildComponentTagName('u1PitVh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u1PitVh');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('u1PitVh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
