...
} elseif ($_instance->childHasBeenRendered('tNxz7Fa')) {
    $componentId = $_instance->getRenderedChildComponentId('tNxz7Fa');
    $componentTag = $_instance->getRenderedChildComponentTagName('tNxz7Fa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tNxz7Fa');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('tNxz7Fa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
