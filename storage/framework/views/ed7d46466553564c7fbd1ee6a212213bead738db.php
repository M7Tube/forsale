...
} elseif ($_instance->childHasBeenRendered('pR1KRaC')) {
    $componentId = $_instance->getRenderedChildComponentId('pR1KRaC');
    $componentTag = $_instance->getRenderedChildComponentTagName('pR1KRaC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pR1KRaC');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('pR1KRaC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
