...
} elseif ($_instance->childHasBeenRendered('AjMNYZR')) {
    $componentId = $_instance->getRenderedChildComponentId('AjMNYZR');
    $componentTag = $_instance->getRenderedChildComponentTagName('AjMNYZR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AjMNYZR');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('AjMNYZR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
