...
} elseif ($_instance->childHasBeenRendered('5h6Hp5O')) {
    $componentId = $_instance->getRenderedChildComponentId('5h6Hp5O');
    $componentTag = $_instance->getRenderedChildComponentTagName('5h6Hp5O');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5h6Hp5O');
} else {
    $response = \Livewire\Livewire::mount('website.ad');
    $html = $response->html();
    $_instance->logRenderedChild('5h6Hp5O', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
