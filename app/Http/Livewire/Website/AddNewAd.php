    ...
    public function add()
    {
        if ($this->category == 1) { //cars
            ...
            $real_estate = RealEstate::Create([
                ...
                'is_special' => $is_spcial->is_spcial ?? 0,
                'watch_count' => 0 ?? 0,
                'apartment_size' => $this->apartment_size ?? 0,
                'land_size' => $this->land_size ?? 0,
                'building_size' => $this->building_size ?? 0,
                'floor' => $this->floor ?? 0,
                'room_count' => $this->room_count ?? 0,
            ...
            $jobs = Jobs::Create([
                ...
                'work_hour' => $this->work_hour ?? 0,
                'extra_work_hour' => $this->extra_work_hour ?? 0,
                'work_hour_rent' => $this->work_hour_rent ?? 0,
                'driving_license' => $this->driving_license ?? 0,
                'picture' => $listOfPicture != [] ? json_encode($listOfPicture) : json_encode(['defualt.png']),
